...
Here is a compiled list of our resources that we used to make TUMMI!
...
- [Robust Automated Malware Unpacker (RoAMer)](https://github.com/hasherezade/mal_unpack)
...
- [Setting up Sandbox for Malware Analysis](https://www.youtube.com/watch?v=oPsxy9JF8FM)
- [How to set up Flare VM on Windows 10](https://youtu.be/2jPqqZFOyO0)

### Unpacking / Malware Analysis

- [UnpacMe: How We Built It And Why](https://www.youtube.com/watch?v=FctDptnYukQ)
- [pwn.college Reverse Engineering Playlist](https://youtube.com/playlist?list=PL-ymxv0nOtqrGVyPIpJeostmi7zW5JS5l)
- [Malware Analysis Bootcamp - Packers & Unpacking](https://www.youtube.com/watch?v=6LAvUbSr1WU)
- [Manually Unpacking the UPX Packer](https://www.youtube.com/watch?v=jfuj0b3Ao1k)

### Executable Formats

- [ELF File Formatting](https://www.youtube.com/watch?v=OBDuoqyZ4UA)
